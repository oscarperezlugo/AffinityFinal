...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:affisDBConnectionString %>' SelectCommand="SELECT [Cedula], [Nombre], [NumeroCertificado], [Estado] FROM [Asegurados] WHERE (([Cedula] = @Cedula) OR ([NumeroCertificado] = @NumeroCertificado)) ">  <%--)--%> <%--([Nombre] LIKE '%' + @Nombre + '%')--%>
                        <SelectParameters>  
                            ...
                            <asp:CookieParameter CookieName="paramCedula" Name="NumeroCertificado" Type="Empty"></asp:CookieParameter>                            
                        </SelectParameters>
                    </asp:SqlDataSource>       
                    <hr />
                    <CENTER>

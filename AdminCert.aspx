    ...
    <div class="card">
        ...
        <div class="card-body">
                <div class="form-row">
                    <table style="width: 100%;">
                        <tr>
                            <td><asp:Label ID="Label1" runat="server" Text="DESDE" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                <input class="formularioProc" id="Text4" type="text" runat="server"   disabled/>
                            </td>
                        ...
                        <tr>
                            <td><asp:Label ID="Label4" runat="server" Text="EJECUTIVO ASIGNADO" Style="font-weight: bold; font-size: 18px;"></asp:Label>
                                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="formularioProc" AppendDataBoundItems="true" DataTextField="Nombre" DataValueField="Nombre">
                    ...
                    <hr />  
                        <center><asp:Label ID="Label3" runat="server" Text="OBSERVACIONES" Style="font-weight: bold; font-size: 18px;"></asp:Label>

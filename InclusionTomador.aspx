                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>
                                ...
                                <input class="formularioProc" placeholder="TELEFONO CELULAR" id="Text9" type="number" runat="server"  />
                            </td>
                            <td>
                                <asp:Label ID="Label12" runat="server" Text="TELEFONO EMPRESA" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                <input class="formularioProc" placeholder="TELEFONO EMPRESA" id="Text10" type="number" runat="server"  />
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label17" runat="server" Text="EMPLEADOR" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                                <asp:DropDownList ID="DropDownList3" runat="server" CssClass="formularioProc"  DataTextField="NombreComercial" DataValueField="NombreComercial" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="fijarempresa">
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label15" runat="server" Text="¿EL TOMADOR ES UN ASEGURADO?" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
                            ...
                            <td>
                                ...
                                <input class="formularioProc" placeholder="Cedula" id="Text14" type="date" runat="server"  />
                            </td>
                            <td>
                                <asp:Label ID="Label14" runat="server" Text="MEDIO DE COBRO" Style="font-weight: bold; font-size: 18px;"></asp:Label><br />
